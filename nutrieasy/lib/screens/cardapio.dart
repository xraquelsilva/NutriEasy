...
class _Cardapiostate extends State<Cardapio>{
  ...
  List<String> dropOpcoes = ['hoje', '16/08', '17/08', '18/08', '19/08', '20/08'];
          ...
          child: GestureDetector(
            onTap:() {
              if (dia==Null || dia.isEmpty){
               ...
               MaterialPageRoute(builder: (context) => Refeicaodetalhes(titulo: lanchedamanha, data:dia )));
              }
            ...
            child:Container(
              ...
              BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/nutri_img/cafedamanha.png'),
                  fit:BoxFit.cover,
          ...
          child: GestureDetector(
            ...
            child:Container(
              ...
              BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                image: DecorationImage(
                  image: AssetImage('assets/nutri_img/lanchedamanha.png'),
                  fit:BoxFit.cover,
                  colorFilter:ColorFilter.mode(Colors.black.withOpacity(0.4), BlendMode.colorBurn))
              ),
              child: SizedBox(
          ...
          child: GestureDetector(
            ...
            child:Container(
              ...
              BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                image: DecorationImage(
                  image: AssetImage('assets/nutri_img/almoco.png'),
                  fit:BoxFit.cover,
                  colorFilter:ColorFilter.mode(Colors.black.withOpacity(0.4), BlendMode.colorBurn))
              ),
              child: SizedBox(
          ...
          child: GestureDetector(
            ...
            child:Container(
              ...
              BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                image: DecorationImage(
                  image: AssetImage('assets/nutri_img/lanchedatarde.png'),
                  fit:BoxFit.cover,
                  colorFilter:ColorFilter.mode(Colors.black.withOpacity(0.4), BlendMode.colorBurn))
              ),
              child: SizedBox(
